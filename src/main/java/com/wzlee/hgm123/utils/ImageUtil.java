...
public class ImageUtil {
    ...
    private static int height = 20;//图片高
    ...
    public static void main(String[] args) {
        // 1-缩放图像：
        // 方法一：按比例缩放
        ImageUtil.scale("e:/abc.jpg", "E:/scale.JPG", 5, true);//测试OK
        // 方法二：按高度和宽度缩放
...
//        // 6-给图片添加图片水印：
     ...
     * @throws IOException 
     */
    public static void randCaptcha(HttpServletRequest request,HttpServletResponse response) throws IOException {
		...
		gra.setFont(new Font("Times New Roman", Font.BOLD, 22));
