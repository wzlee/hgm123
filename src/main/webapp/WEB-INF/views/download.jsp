...
<html lang="zh">
  ...
  <body>
          		...
          		<ul class="nav pull-left">
            		...
            		<li>
				        <div class="navbar-form pull-left">
				        	<input class="span3 input-filter" type="text" placeholder="输入搜索关键字(如:'登陆器','服务端')..." required>
					  	</div>
			    	</li>
			    	<li class="divider-vertical"></li>
               	</ul>
    ...
    <div class="modal hide fade use-template-modal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		...
		<div class="modal-footer">
			<div class="usage-tip pull-left"><i class="icon-tag"></i> 使用网站模板建站收费标准为:8元/天(3天起)</div>
    ...
    <div class="container">
    	<div class="container-fluid">
			<div class="carousel slide source-carousel">
