...
* @modify data 2013-05-30
* @version 1.13 beta
* ............................................................................
* ............................................................................
* yy open platform client javascript sdk 
* 广州欢聚时代科技有限公司 版权所有 (c) 2005-2013 DuoWan.com [多玩游戏]
...
IYYChannelMicList.prototype.getLinkedMicList = function () {
    ...
    if (result.ret === 0) {
        return { ret: 0, linkedMicList: result.linked_mic_list };
    }
    else {
        return result;
    }
...
/**
* 发送麦序提醒给2号麦用户。需要有管理员及以上权限，规则和权限同YY客户端一致。
* @returns 返回调用是否成功，具体属性如下。<br/>
* <b>ret</b>: Number类型 返回码 0=成功，非0值失败，具体请参考错误代码。<br/>
* @type Object
*/
...
IYYIM.prototype.getIMUserInfo = function (uid) {
    ...
    if (result.ret === 0) {
        return { ret: 0, uid: result.uid, imId: result.imid, name: result.nick_name };
    }
    else {
        return result;
    }
...
* 关注某人。
* @private
* @param {Number} uid 被关注的人的uid。
* @returns 返回调用是否成功，具体属性如下。<br/>
* <b>ret</b>: Number类型 返回码 0=成功，非0值失败，具体请参考错误代码。<br/>
* @type Object
*/
IYYInteraction.prototype.follow = function (uid) {
    if (arguments.length !== 1) return { ret: yy_e_api_param_error };
    if (typeof (uid) !== "number") return { ret: yy_e_api_param_error };
    var result = callExternal("IInteraction_Follow", uid);
    return result;
};
...
* 取消关注某人。
* @private
* @param {Number} uid 被取消关注的人的uid。
* @returns 返回调用是否成功，具体属性如下。<br/>
* <b>ret</b>: Number类型 返回码 0=成功，非0值失败，具体请参考错误代码。<br/>
* @type Object
*/
IYYInteraction.prototype.unfollow = function (uid) {
    if (arguments.length !== 1) return { ret: yy_e_api_param_error };
    if (typeof (uid) !== "number") return { ret: yy_e_api_param_error };
    var result = callExternal("IInteraction_UnFollow", uid);
    return result;
};
...
* @private
* @param {Number} uid 被取消关注的人的uid。
* @returns 返回粉丝数量信息，是一个Object对象，具体属性如下。<br/>
* <b>ret</b>: Number类型 返回码 0=成功，非0值失败，具体请参考错误代码。<br/>
* <b>count</b>: Number类型 我的粉丝的数量 <br/>
* @type Object
* @example 
* 使用示例:
* var result = yy.interaction.getFansCount();
* if (result.ret == 0) {
*     document.getElementById("txtLog").innerHTML = "我的粉丝数=" + result.count;
* }
* 成功的返回值示例:{ ret:0,count:12}
* 失败的返回值示例:{ ret:984832}
*/
IYYInteraction.prototype.getFansCount = function () {
    var result = callExternal("IInteraction_GetFansCount");
    if (result.ret == 0) {
        return { ret: 0, count: result.count };
    }
    else {
        return result;
    }
...
* 查询我是否是某人的粉丝。
* @private
* @param {Number} uid 某人的uid。
* @returns 返回粉丝数量信息，是一个Object对象，具体属性如下。<br/>
* <b>ret</b>: Number类型 返回码 0=成功，非0值失败，具体请参考错误代码。<br/>
* <b>isFans</b>: Number类型 我的粉丝的数量 <br/>
* @type Object
* @example 
* 使用示例:
* var result = yy.interaction.isFans(2323533);
* if (result.ret == 0) {
*     document.getElementById("txtLog").innerHTML = "我是否是2323533的粉丝?"+(result.isFans?"是":"不是");
* }
* 成功的返回值示例:{ ret:0,isFans:true}
* 失败的返回值示例:{ ret:984832}
*/
IYYInteraction.prototype.isFans = function (uid) {
    if (arguments.length !== 1) return { ret: yy_e_api_param_error };
    if (typeof (uid) !== "number") return { ret: yy_e_api_param_error };
    var result = callExternal("IInteraction_IsFans", uid);
    if (result.ret == 0) {
        return { ret: 0, isFans: result.isFans };
    }
    else {
        return result;
    }
...
* <b>ret</b>: Number类型 返回码 0=成功，非0值失败，具体请参考错误代码。<br/>
* <b>ownerAppId</b>: Number类型 占用临时语音的应用的AppId。<br/>
* @type Object
* @example 
* 使用示例:
* var result = yy.tempAudioSession.getOwner();
* if (result.ret == 0) {
*   document.getElementById("txtLog").innerHTML = "当前房间的音量 volume="+result.ownerAppId;
* }
    ...
    try {
        ...
        switch (arguments[0]) {
            ...
            case "IYY_GetVersion":
                ...
                //ret = yyApiMaps[arguments[0]]();
                break;
            case "IYYEx_GetYYVersion":
                ret = yyexternal.IYYEx_GetYYVersion();
                //ret = yyApiMaps["IYYEx_GetYYVersion"]();
                break;                
